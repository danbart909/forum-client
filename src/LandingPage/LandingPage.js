      ...
      <>
        ...
        <section id='s-landing'>
          <div id='div-landing-info'>
            ...
            <p>Threads in the Forum Overview are ordered by timestamp of last reply, meaning threads with more recent posts will be at the top (posting a reply in a thread will move that thread to the top of the forum list). Replies in the thread are listed chronologically.</p>
          </div>
